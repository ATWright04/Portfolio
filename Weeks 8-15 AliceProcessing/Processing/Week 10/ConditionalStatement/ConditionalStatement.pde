//Andrew Wright 11/4/21
//Conditional Statement on user input and computer function
...
float y;
float d = 100;
float b = 10; // b for border of the object
...
void draw() { //draw block with no return
